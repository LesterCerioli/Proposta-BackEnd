...
namespace Propostas.Infra.Data.Migrations
{
    ...
    [Migration("20190222181806_AlteringTypesPropostaCustoTotal")]
    partial class AlteringTypesPropostaCustoTotal
    {
            ...
            modelBuilder.Entity("Propostas.Domain.Models.Proposta", b =>
                {
                    ...
                    b.Property<string>("ObjetivoProposta");
            ...
            modelBuilder.Entity("Propostas.Domain.Models.Proposta", b =>
                {
                    ...
                    b.HasOne("Propostas.Domain.Models.Recurso", "LiderProposta")
                        .WithMany("LiderProposta")
                        .HasForeignKey("LiderPropostaId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Propostas.Domain.Models.Recurso", "LiderSolucao")
                        .WithMany("LiderSolucao")
                        .HasForeignKey("LiderSolucaoId")
                        .OnDelete(DeleteBehavior.Restrict);
