namespace Propostas.Infra.CrossCutting.Templates
{
    using System;
    using System.IO;
    using System.Text;
    ...
    internal class Program
    {
        ...
        private static void ReadInputs()
        {
            ...
            //Console.Write("Deseja gerar apenas as camadas do Model?  Sim (S) ou Não(N): ");
        ...
        {
            var destinationPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Web.Api\Controllers"));
        ...
        {
            var destinationPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Application\Interfaces"));
        ...
        {
            var destinationPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Application\Services"));
        ...
        {
            var destinationPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Application\ViewModels"));
        ...
        {
            var destinationPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Application\Filters"));
        ...
        {
            var autoMapperConfigPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Application\AutoMapper"));
        ...
        {
            var destinationPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Domain\Interfaces"));
        ...
        {
            var destinationPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Domain\Models"));
        ...
        {
            var contextConfigPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Infra.Data\Context"));
            var contextConfigFilePath = string.Format(@"{0}\PropostasContext.cs", contextConfigPath);
        ...
        {
            var destinationPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Infra.Data\Mappings"));
        ...
        {
            var destinationPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Infra.Data\Repository"));
        ...
        {
            var destinationPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Infra.Data\Seeds"));
        ...
        {
            var startUpConfigPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Web.Api"));
        ...
        {
            var seedInitializerConfigPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Infra.Data\Seeds"));
        ...
        private static void CreateInfraCrossCuttingTemplates()
        {
            ...
            var infraCrossCuttingTemplatePath = Path.GetFullPath(Path.Combine(currentPath, @"4.2 - Infra.CrossCutting"));
            AddIoCConfig();
        }

        private static void AddIoCConfig()
        {
            var iocConfigPath = Path.GetFullPath(Path.Combine(currentPath, @"..\Propostas.Infra.CrossCutting.IoC"));
